    ...
    <footer id="contato" className="footer">
      <div className="footerContent">
        <div className="footerAbout">
          <h3>Sobre nós</h3>
          <p>
            A GA Brasil Cosméticos é uma distribuidora de cosméticos que se destaca no mercado brasileiro, com foco em fornecer produtos de maquiagem a preços de atacado diretamente da Rua 25 de Março, um dos maiores centros comerciais do país. Com mais de 24 anos de experiência, a empresa se consolidou como referência em maquiagem acessível, oferecendo marcas como Bella Angel, Kyrav, Fenzza e Max Love — com catálogo que vai de bases e corretivos a séruns, águas micelares e acessórios. Atendemos lojistas e revendedores em todo o Brasil através de WhatsApp, site e redes sociais, com preços competitivos, condições especiais de pagamento e suporte dedicado para o crescimento do seu negócio.
          </p>
        </div>
        ...
        <div className="footerBrand">
          ...
          <div className="footerSocials">
            ...
            <a
              href="https://www.facebook.com/gabrasilmakeup/"
              target="_blank"
              rel="noreferrer"
              aria-label="Facebook"
            >
